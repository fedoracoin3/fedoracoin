...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About FedoraCoin"), this);
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(242,242,242); }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    //{
        ...
        appMenuBar->setMaximumWidth(140);
...
{
    QString strTitle = tr("FedoraCoin") + " - ";
