...
"for example: alertnotify=echo %%s | mail -s \"FedoraCoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. FedoraCoin is shutting down."),
